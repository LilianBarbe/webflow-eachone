...
(() => {
  ...
  // src/utils/swiper/logo.js
  var sliderComponents2 = document.querySelectorAll(".slider-logo_component");
  sliderComponents2.forEach((component) => {
  ...
  // src/utils/swiper/testimonials.js
