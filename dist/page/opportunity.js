...
(() => {
  ...
  setupVideoSwiper();
  setupForms();
  var sectionLeadAio = document.querySelector('[section="lead-aio"]');
  var sectionLeadOrganisation = document.querySelector('[section="lead-orga"]');
  var sectionKnown = document.querySelector('[section="known-lead-aio"]');
  var btnPostuler = document.querySelectorAll('[btn-postuler="true"]');
  ...
  function displayAppropriateSection() {
    if (checkIfQueryParamExists("application_mail_address")) {
      ...
      sectionLeadAio.style.display = "none";
      sectionLeadOrganisation.style.display = "none";
      sectionKnown.style.display = "block";
    } else if (checkIfQueryParamExists("application_prescribing_organisation")) {
      console.log("urlPrescribingEtCreation");
      sectionLeadAio.style.display = "none";
      sectionKnown.style.display = "none";
      sectionLeadOrganisation.style.display = "block";
      document.querySelector(".form-question-wrapper.is-prescribing").style.display = "none";
    } else {
      console.log("url rien");
      sectionLeadAio.style.display = "none";
      sectionKnown.style.display = "none";
      sectionLeadOrganisation.style.display = "block";
    }
