...
(() => {
  ...
  // node_modules/.pnpm/npm.greensock.com+@gsap+shockingly@3.12.4/node_modules/gsap/dist/gsap.js
  var require_gsap = __commonJS({
    "node_modules/.pnpm/npm.greensock.com+@gsap+shockingly@3.12.4/node_modules/gsap/dist/gsap.js"(exports, module) {
      init_live_reload();
      (function(global, factory) {
        ...
        Tween.version = Timeline.version = gsap2.version = "3.12.4";
        _coreReady = 1;
        _windowExists() && _wake();
  ...
  // node_modules/.pnpm/npm.greensock.com+@gsap+shockingly@3.12.4/node_modules/gsap/dist/ScrollSmoother.js
  var require_ScrollSmoother = __commonJS({
    "node_modules/.pnpm/npm.greensock.com+@gsap+shockingly@3.12.4/node_modules/gsap/dist/ScrollSmoother.js"(exports, module) {
      init_live_reload();
      (function(global, factory) {
        typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global = global || self, factory(global.window = global.window || {}));
      })(exports, function(exports2) {
        ...
        var gsap2, _coreInitted, _win, _doc, _docEl, _body, _toArray, _clamp, ScrollTrigger, _mainInstance, _expo, _getVelocityProp, _inputObserver, _context, _onResizeDelayedCall, _windowExists = function _windowExists2() {
          return typeof window !== "undefined";
        ...
        var ScrollSmoother2 = function() {
          function ScrollSmoother3(vars) {
            var _this = this;
            _coreInitted || ScrollSmoother3.register(gsap2) || console.warn("Please gsap.registerPlugin(ScrollSmoother)");
            vars = this.vars = vars || {};
            ...
            var _vars = vars, smoothTouch = _vars.smoothTouch, _onUpdate = _vars.onUpdate, onStop = _vars.onStop, smooth = _vars.smooth, onFocusIn = _vars.onFocusIn, normalizeScroll = _vars.normalizeScroll, wholePixels = _vars.wholePixels, content, wrapper, height, mainST, effects, sections, intervalID, wrapperCSS, contentCSS, paused, pausedNormalizer, recordedRefreshScroll, recordedRefreshScrub, allowUpdates, self2 = this, effectsPrefix = vars.effectsPrefix || "", scrollFunc = ScrollTrigger.getScrollFunc(_win), smoothDuration = ScrollTrigger.isTouch === 1 ? smoothTouch === true ? 0.8 : parseFloat(smoothTouch) || 0 : smooth === 0 || smooth === false ? 0 : parseFloat(smooth) || 0.8, speed = smoothDuration && +vars.speed || 1, currentY = 0, delta = 0, startupPhase = 1, tracker = _getVelocityProp(0), updateVelocity = function updateVelocity2() {
              ...
              if (y !== currentY && !paused || force) {
                ...
                delta = y - currentY;
                currentY = y;
                ScrollTrigger.isUpdating || ScrollSmoother3.isRefreshing || ScrollTrigger.update();
              }
            ...
            this.scrollTo = function(target, smooth2, position) {
              var p = gsap2.utils.clamp(0, _maxScroll(), isNaN(target) ? _this.offset(target, position, !!smooth2 && !paused) : +target);
            ...
            "overscrollBehavior" in _win.getComputedStyle(_body) && gsap2.set([_body, _docEl], {
              overscrollBehavior: "none"
            });
            "scrollBehavior" in _win.getComputedStyle(_body) && gsap2.set([_body, _docEl], {
              scrollBehavior: "auto"
            });
          ...
          ScrollSmoother3.register = function register(core) {
            if (!_coreInitted) {
              gsap2 = core || _getGSAP();
              ...
              if (gsap2) {
                ...
                if (_body && ScrollTrigger) {
                  ...
                  ScrollSmoother3.refresh = ScrollTrigger.refresh;
                  _coreInitted = 1;
                }
              }
            }
        ...
        ScrollSmoother2.version = "3.12.4";
        ScrollSmoother2.create = function(vars) {
          return _mainInstance && vars && _mainInstance.content() === _toArray(vars.content)[0] ? _mainInstance : new ScrollSmoother2(vars);
        };
        ScrollSmoother2.get = function() {
          return _mainInstance;
        };
        _getGSAP() && gsap2.registerPlugin(ScrollSmoother2);
  ...
  var import_ScrollSmoother = __toESM(require_ScrollSmoother(), 1);
  ...
  // src/page/home/index.js
  import_gsap.gsap.registerPlugin(import_ScrollSmoother.ScrollSmoother);
  import_ScrollSmoother.ScrollSmoother.create({
    smooth: 1.5,
    effects: false,
    smoothTouch: 0.1
  });
  var sliderComponents = document.querySelectorAll(".slider-logo_component");
  ...
  document.querySelectorAll(".testimonial_button-radio").forEach((element) => {
    element.addEventListener("click", function() {
      ...
      if (choice === "Entreprises") {
        ...
        document.querySelector(".testimonial_btn-wrap.is-entreprise").classList.add("active-slide");
        document.querySelector(".testimonial_btn-wrap.is-candidat").classList.remove("active-slide");
      } else {
        ...
        document.querySelector(".testimonial_btn-wrap.is-entreprise").classList.remove("active-slide");
      }
    });
  });
  document.querySelector(".testimonial_btn-wrap.is-candidat").classList.add("active-slide");
